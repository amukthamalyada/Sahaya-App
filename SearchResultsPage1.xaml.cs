...
namespace Sahaya
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage1 : Sahaya.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            foreach (var group in groups)
            {
                ...
                {
                    if (item.Title.ToLower().Contains(query) || item.Title.ToLower().Contains(query))
                    {
                        all.Add(item);
                        items.Add(item);
                    }
        ...
        /// </summary>
        private sealed class Filter : Sahaya.Common.BindableBase
        {
        ...
        private void OnItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(ItemDetailPage1), ((SampleDataItem)e.ClickedItem).UniqueId);
        }
    }
}
